...
/*   Updated: 2024/01/04 14:48:25 by bschaafs      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
#define MLX_NONNULL(var)                                                       \
	MLX_ASSERT(var, "Value can't be null"); /* Assert instead of attribute */
...
mlx_list_t *mlx_lstremove(mlx_list_t **lst, void *value,
						  bool (*comp)(void *, void *));
...
void mlx_draw_instance(mlx_ctx_t *mlx, mlx_image_t *img,
